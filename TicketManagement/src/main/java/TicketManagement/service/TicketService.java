...
public interface TicketService
{
	 ...
	 * @throws TicketManagementException
	 */
	String reserveSeats(int seatHoldId, String customerEmail) throws TicketManagementException;
	 ...
	 * @throws TicketManagementException
	 */
	void cancelHeldSeats(SeatHold seatHoldId) throws TicketManagementException;
}